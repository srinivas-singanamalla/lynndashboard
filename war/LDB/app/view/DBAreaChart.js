...
Ext.define("LDB.view.DBAreaChart", {
	...
	xtype : 'dbareachart',
	/*
	 * requires: ['Ext.chart.Panel', 'Ext.chart.Chart',
	 * 'Ext.chart.axis.Numeric', 'Ext.chart.axis.Category',
	 * 'Ext.chart.series.Area', 'Ext.draw.engine.ImageExporter'],
	 */

	requires : [ 'Ext.chart.axis.Axis', 'Ext.chart.axis.Category',
			'Ext.chart.axis.Numeric', 'Ext.chart.series.Area',

			'Ext.chart.Legend', 'Ext.chart.Panel',

			'Ext.chart.theme.GridStyle', 'Ext.chart.theme.OddStyle',
			'Ext.chart.theme.Theme', 'Ext.chart.theme.MarkerStyle',
			'Ext.chart.theme.LabelStyle', 'Ext.chart.theme.Style',
			'Ext.chart.theme.Base', 'Ext.chart.theme.Demo',
			'Ext.chart.Toolbar',

			'Ext.data.JsonStore',

			'Ext.draw.Surface', 'Ext.draw.Sprite', 'Ext.draw.engine.Canvas',
			'Ext.draw.CompositeSprite', 'Ext.draw.engine.ImageExporter',

			'Ext.fx.Sprite' ],
	/*
	 * config : { autoSize : true, title : 'Area Chart Test', width : 450,
	 * height : 450 },
	 */
